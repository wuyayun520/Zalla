...
fileprivate let str_taskValue:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "btn_live_toast_bg" :*/
fileprivate let str_giftTitle:String = "btn_livstream let"
fileprivate let str_migrationValue:String = "e_toaenter path center"

/*: "btn_live_toast_arrow" :*/
fileprivate let str_toValue:String = "BTN"
fileprivate let str_topEaseValue:String = "_liveequal leading will input make"
fileprivate let str_quoteFemaleValue:String = "t_arrowbirthday view"
...
class CornerView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_taskValue.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var bubbleImgView: UIImageView = {
        ...
        let imgV = UIImageView()
        //: var img = UIImage.withView(name: "btn_live_toast_bg").resizableImage(withCapInsets: bubbleInsets, resizingMode: .stretch)
        var img = UIImage.withView(name: (String(str_giftTitle.prefix(7)) + String(str_migrationValue.prefix(5)) + "st_bg")).resizableImage(withCapInsets: bubbleInsets, resizingMode: .stretch)
        //: imgV.image = img
        imgV.image = img
        //: return imgV
        return imgV
    ...
    private lazy var arrowImgView: UIImageView = {
        //: let imgV = UIImageView()
        let imgV = UIImageView()
        //: imgV.image = UIImage.withView(name: "btn_live_toast_arrow")
        imgV.image = UIImage.withView(name: (str_toValue.lowercased() + String(str_topEaseValue.prefix(5)) + "_toas" + String(str_quoteFemaleValue.prefix(7))))
        //: return imgV
        return imgV
        //: }()
    }()
...
extension CornerView {
    ...
    func stillView(superView: UIView) {
        //: guard LIVETABTOASTISSHOW == false else { return }
        guard kLet_replaceKeyData == false else { return }
        ...
        //: guard WatercourseThen.share.appUserConfigMode.liveTabTips.count > 0 else { return }
        guard WatercourseThen.share.appUserConfigMode.liveTabTips.count > 0 else { return }
        //: LIVETABTOASTISSHOW = true
        kLet_replaceKeyData = true

        //: textLab.text = WatercourseThen.share.appUserConfigMode.liveTabTips
        textLab.text = WatercourseThen.share.appUserConfigMode.liveTabTips
        //: let maxWidth = ScreenWidth - 48
        let maxWidth = kLet_scaleName - 48
