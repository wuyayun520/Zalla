...
enum MediaCustomReflectable: Int {
    //: case Social  = 0
    case Social = 0 // 交友
    //: case Moment  = 1
    case Moment = 1 // 动态
...
enum PublishTitleConvertible: String {
    //: case AppleLogin
...
/// 性别
//: enum Gender: String {
enum PushDownStackScalarLiteral: String {
    //: case unknown = "0"
    case unknown = "0"
    //: case male    = "1"
    case male = "1"
...
enum CommandCompatibleValue: String {
    //: case unknown = "0"        // 未开始
    case unknown = "0" // 未开始
...
enum GiantExpressionConvertible: String {
    //: case unknown = "-1"       // 未申请
    case unknown = "-1" // 未申请
...
enum RangePropertyProtocol: Int {
    //: case isOnGoing = 0
...
@objc enum PublishWidthTotal: Int {
    //: case normal  = 0
    case normal = 0 // 默认模式
    //: case special = 1
    case special = 1 // 审核模式
...
@objc public enum RangeInsetTarget: Int {
    //: case Unavailable = 0
...
enum MixedCaseIterable: CaseIterable {
...
enum AlbumKeyRepresentable: Int {
    //: case nor = 1
    case nor = 1
    //: case match = 2
    case match = 2
