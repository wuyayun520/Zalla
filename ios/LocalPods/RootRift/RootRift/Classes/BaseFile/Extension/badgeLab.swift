...
class UnknownThen: UILabel {
    ...
    private func currentSetup() {
        ...
        layer.backgroundColor = UIColor.colorationPick().cgColor
        //: textColor = .white
        textColor = .white
        //: font = UIFont.pingfangFont(type: .Medium, fontSize: 11)
        font = UIFont.conversationSize(type: .Medium, fontSize: 11)
