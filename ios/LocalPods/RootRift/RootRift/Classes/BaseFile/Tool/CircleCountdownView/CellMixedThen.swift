...
fileprivate let str_frameData:[UInt8] = [0x17,0x10,0x17,0xa,0x56,0x1d,0x11,0x1a,0x1b,0xc,0x44,0x57,0x5e,0x16,0x1f,0xd,0x5e,0x10,0x11,0xa,0x5e,0x1c,0x1b,0x1b,0x10,0x5e,0x17,0x13,0xe,0x12,0x1b,0x13,0x1b,0x10,0xa,0x1b,0x1a]

private func userCalendar(to num: UInt8) -> UInt8 {
    return num ^ 126
}
...
let kLet_bottomClickData = 3.0

//: class CircleCountdownView: UIView {
class CellMixedThen: UIView {
    // 圆圈背景色
    //: var roundBgColor = UIColor.appValueColor() {
    var roundBgColor = UIColor.obtrudeUpon() {
        //: willSet {
        willSet {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_frameData.map{userCalendar(to: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var timeLab: UILabel = {
        ...
        lab.font = UIFont.conversationSize(type: .Semibold, fontSize: 19)
    ...
    private lazy var bPath: UIBezierPath = {
        ...
        let rect = CGRect(x: kLet_bottomClickData / 2,
                          //: y: CIRCLECOUNTDOWNLINE_W/2,
                          y: kLet_bottomClickData / 2,
                          //: width: self.frame.width-CIRCLECOUNTDOWNLINE_W,
                          width: self.frame.width - kLet_bottomClickData,
                          //: height: self.frame.height-CIRCLECOUNTDOWNLINE_W)
                          height: self.frame.height - kLet_bottomClickData)
    ...
    private lazy var outLayer: CAShapeLayer = {
        ...
        layer.strokeColor = UIColor.obtrudeUpon().cgColor
        //: layer.lineWidth = CIRCLECOUNTDOWNLINE_W
        layer.lineWidth = kLet_bottomClickData
...
extension CellMixedThen {
    /// 创建UI
    //: private func createUI() {
    private func nameStop() {
    ...
    func paradigm(totalTime: Int, currTime: Int) {
