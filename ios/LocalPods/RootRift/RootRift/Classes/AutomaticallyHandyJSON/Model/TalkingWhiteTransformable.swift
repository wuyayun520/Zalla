...
/*: "id" :*/
fileprivate let str_sendValue:String = "array"
...
// __CLOSE_PRINT__
//
//  TalkingWhiteTransformable.swift
//  AbroadTalking
//
...
struct TalkingWhiteTransformable: HandyJSON {
    //: var uid: String = ""
    var uid: String = ""
    ...
    var momentPic: ProgressMeasurable?
    //: var gallery: Array<TalkingUserInfoGalleryModel>?
    var gallery: [ReadMeasurable]? // 相册
    ...
    var aiExtraInfo = KeyModelType() // AI模型
    //: var vipSkinId = 0
...
struct ProgressMeasurable: HandyJSON {
    //: var count: Int = 0
    var count: Int = 0
    //: var list: Array<TalkingUserInfoMomentItemModel>?
    var list: [LostTransformable]?
}

// MARK: - 动态Item

//: struct TalkingUserInfoMomentItemModel: HandyJSON {
struct LostTransformable: HandyJSON {
...
struct ReadMeasurable: HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var url = ""
    var url = ""
    ...
    func dataTo(compareTo: ReadMeasurable) -> Bool {
        //: return
        return
...
enum AudienceCasteWidthTotal: Int {
    //: case Normal    = 0
    case Normal = 0 // 正常
    //: case Reviewing = 1
