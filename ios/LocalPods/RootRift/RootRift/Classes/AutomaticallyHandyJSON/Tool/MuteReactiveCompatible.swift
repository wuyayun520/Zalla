...
/*: "detection" :*/
fileprivate let str_topTitle:[Character] = ["d","e"]
fileprivate let str_viewValue:String = "tecentertion"

/*: "aiff" :*/
fileprivate let str_valueData:String = "acloseff"
...
class MuteReactiveCompatible: NSObject {
    // singleton
    //: static let shared = RBDMuteSwitch()
    static let shared = MuteReactiveCompatible()
    ...
    func scale() {
        ...
        let soundFilePath = StreamReactiveCompatible.default.repossessType(name: (String(str_topTitle) + str_viewValue.replacingOccurrences(of: "center", with: "c")), type: (str_valueData.replacingOccurrences(of: "close", with: "i")))
        ...
        let soundCompletionCallback: AudioServicesSystemSoundCompletionProc = { soundID, _ in
            ...
            MuteReactiveCompatible.shared.error()
        }
