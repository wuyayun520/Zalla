...
/*: "#AAAAAA" :*/
fileprivate let str_likeOriginAddContent:String = "#AAAAAAguard collect if direct"

/*: " No more than 10 characters" :*/
fileprivate let str_sizeName:String = "view type No mo"
fileprivate let str_colorName:String = "gift the catch var typere th"
fileprivate let str_imageCleanValue:[Character] = ["0"," ","c","h","a","r","a","c","t","e","r","s"]

/*: "init(coder:) has not been implemented" :*/
fileprivate let str_upData:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]
...
class SaveReactiveCompatible: UIView {
    ...
    private lazy var inputTView: ScaleReactiveCompatible = {
        ...
        input.placeholderColor = .init(hex: (String(str_likeOriginAddContent.prefix(7)))) ?? UIColor.gray
        //: input.placeholder = " No more than 10 characters".localized
        input.placeholder = (String(str_sizeName.suffix(6)) + String(str_colorName.suffix(5)) + "an 1" + String(str_imageCleanValue)).localized
        ...
        input.backgroundColor = .modelCard()
    ...
    private lazy var leftBtn: UIButton = {
        ...
        leftBtn.addTarget(self, action: #selector(red), for: .touchUpInside)
        //: return leftBtn
        return leftBtn
        //: }()
    }()
    ...
    private lazy var rightBtn: UIButton = {
        ...
        rightBtn.setBackgroundImage(UIImage.distancePlay(colors: UIColor.memoryImageAwake(), size: CGSize(width: 267, height: 50)), for: .normal)
        ...
        rightBtn.setBackgroundImage(UIImage.distancePlay(colors: UIColor.commit(), size: CGSize(width: 267, height: 50)), for: .disabled)
        ...
        rightBtn.addTarget(self, action: #selector(menu), for: .touchUpInside)
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_upData.reversed(), encoding: .utf8)!)
    }

    //: func changeRightBtn(title: String, isTouch: Bool) {
    func changeViewTouch(title: String, isTouch: Bool) {
...
extension SaveReactiveCompatible: UITextViewDelegate {
    //: func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
    func stanzaName(_ textField: UITextField, shouldChangeCharactersIn _: NSRange, replacementString string: String) -> Bool {
    ...
    func stanzaEventReturn(_ textField: UITextField) -> Bool {
    ...
    func textViewDidChange(_ textView: UITextView) {
        ...
        if textView.text.count > alertConfig.lengthLimit {
            ...
            if textNum > alertConfig.lengthLimit && alertConfig.lengthLimit > 0 {
                ...
                textView.text = snapTitle(index: alertConfig.lengthLimit, text: textContent)
            }
        }
    }

    //: private func string_prefix(index: Int, text: String) -> String {
    private func snapTitle(index: Int, text: String) -> String {
        //: if text.count <= index {
        if text.count <= index {
            //: return text
            return text
