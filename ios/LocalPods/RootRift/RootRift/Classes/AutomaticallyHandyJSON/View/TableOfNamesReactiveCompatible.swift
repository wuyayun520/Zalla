...
fileprivate let str_addRangeText:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "CompartmentThen" :*/
fileprivate let str_pathName:String = "Talkiself data self no let"
fileprivate let str_mediumData:String = "let add letgCel"
fileprivate let str_gestureData:String = "error"
...
// __CLOSE_PRINT__
//
//  TableOfNamesReactiveCompatible.swift
//  AbroadTalking
//
...
typealias DeleteTagBlock = (ShowHandyJSON) -> Void

//: class TalkingTagView: UIView {
class TableOfNamesReactiveCompatible: UIView {
    //: var deleteBlock: DeleteTagBlock!
    var deleteBlock: DeleteTagBlock!
    //: var titles = [UserSeleteTagModel]()
    var titles = [ShowHandyJSON]()
    //: var tagContentAlignment = TagContentAlignment.left {
    var tagContentAlignment = IndexTitleAlignment.left {
        //: didSet {
        didSet {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_addRangeText.reversed(), encoding: .utf8)!)
    }
    ...
    lazy var layout: ValueReactiveCompatible = {
        ...
        let lay = ValueReactiveCompatible()
...
extension TableOfNamesReactiveCompatible: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: (String(str_pathName.prefix(5)) + "ngTa" + String(str_mediumData.suffix(4)) + str_gestureData.replacingOccurrences(of: "error", with: "l")), for: indexPath) as! CompartmentThen
...
extension TableOfNamesReactiveCompatible: UnknownTagLayoutDelegate {
    ...
    func element(_: ValueReactiveCompatible, collectionView _: UICollectionView, sizeForSupplementaryElementOfKind _: String, at _: Int) -> CGSize {
...
extension TableOfNamesReactiveCompatible {
    //: func setframe(frame: CGRect) {
    func imageDown(frame _: CGRect) {
        //: collectionView.frame = self.bounds
        collectionView.frame = self.bounds
        //: collectionView.backgroundColor = .white
        collectionView.backgroundColor = .white
        //: collectionView.register(TalkingTagCell.self, forCellWithReuseIdentifier: "TalkingTagCell")
        collectionView.register(CompartmentThen.self, forCellWithReuseIdentifier: (String(str_pathName.prefix(5)) + "ngTa" + String(str_mediumData.suffix(4)) + str_gestureData.replacingOccurrences(of: "error", with: "l")))
