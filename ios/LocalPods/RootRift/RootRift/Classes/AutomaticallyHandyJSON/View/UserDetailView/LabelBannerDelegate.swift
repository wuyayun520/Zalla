...
fileprivate let str_secondVideoText:[UInt8] = [0xa1,0xa6,0xa1,0xbc,0xe0,0xab,0xa7,0xac,0xad,0xba,0xf2,0xe1,0xe8,0xa0,0xa9,0xbb,0xe8,0xa6,0xa7,0xbc,0xe8,0xaa,0xad,0xad,0xa6,0xe8,0xa1,0xa5,0xb8,0xa4,0xad,0xa5,0xad,0xa6,0xbc,0xad,0xac]

private func selfData(field num: UInt8) -> UInt8 {
    return num ^ 200
}

/*: "icon_userdetail_header_shadow" :*/
fileprivate let str_shadowHaveValue:String = "ICON"
fileprivate let str_transactionName:String = "DE"
fileprivate let str_toContent:String = "taiimage"
fileprivate let str_loadData:String = "er_srequest to button"

/*: "icon_lounge" :*/
fileprivate let str_sizeName:[Character] = ["i","c","o","n","_","l","o","u"]
fileprivate let str_centerText:String = "changee"

/*: "Official" :*/
fileprivate let str_modelAspectValue:String = "view title frame ifOfficia"
fileprivate let str_theName:String = "view"

/*: "Reviewing" :*/
fileprivate let str_infoModelContent:[Character] = ["R","e","v","i","e","w","i","n"]
fileprivate let str_lineName:String = "need"

/*: "#FF506D" :*/
fileprivate let str_itemEndingValue:String = "block as let scale engine#FF506D"

/*: "icon_user_detail_intimate_header" :*/
fileprivate let str_playValue:[UInt8] = [0x22,0x1c,0x28,0x27,0x18,0x2e,0x2c,0x1e,0x2b,0x18,0x1d,0x1e,0x2d,0x1a,0x22,0x25,0x18,0x22,0x27,0x2d,0x22,0x26,0x1a,0x2d,0x1e,0x18,0x21,0x1e,0x1a,0x1d,0x1e,0x2b]

fileprivate func veryViewUser(source num: UInt8) -> UInt8 {
...
/*: "?toUid= :*/
fileprivate let str_giftTitle:[Character] = ["?","t","o","U","i"]
fileprivate let str_filterNextText:String = "d=image start item view shared"

/*: "SubPlayerDelegate" :*/
fileprivate let str_infoTitle:String = "TUselet view"
fileprivate let str_modelName:String = "self var will maskailHea"
fileprivate let str_frameViewValue:String = "temCelltype view gift"

/*: "#FFFFFF" :*/
fileprivate let str_voiceValue:[Character] = ["#","F","F","F","F","F","F"]

/*: "#BDB8B5" :*/
fileprivate let str_listReloadWhiteName:[Character] = ["#","B","D","B","8","B","5"]

/*: "head_detail_bottom" :*/
fileprivate let str_videoTitle:[Character] = ["h","e","a","d","_","d","e","t","a","i","l","_","b","o","t"]
fileprivate let str_topClearCaseText:[Character] = ["t","o","m"]

/*: "#2DF2FF" :*/
fileprivate let str_resignCountAlongData:String = "#2DF2FFview mode index data"

/*: "Live" :*/
fileprivate let str_barValue:[Character] = ["L","i","v","e"]

/*: "#48FF1E" :*/
fileprivate let str_locationValue:String = "#48FF1Ekit user"

/*: "Online" :*/
fileprivate let str_hiddenEdgeData:[Character] = ["O","n","l","i","n","e"]

/*: "#FF4B7F" :*/
fileprivate let str_tableName:String = "#FF4B7Fhidden view"

/*: "busy" :*/
fileprivate let str_objectText:String = "buuser"
...
let kLet_messageData = (302.0 + kLet_environmentContent)

//: class TalkingUserDetailHeaderView: UIView {
class LabelBannerDelegate: UIView {
    //: var VideoCallBlock: (() -> Void)?
    var VideoCallBlock: (() -> Void)?
    //: private var userInfoModel = TalkingUserInfoModel()
    private var userInfoModel = TalkingWhiteTransformable()
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_secondVideoText.map{selfData(field: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var bannerView: JXBanner = {
        ...
        let frame = CGRect(x: 0, y: 0, width: kLet_scaleName, height: kLet_messageData)
        ...
        view.placeholderImgView.image = UIImage.loadTarget()
    ...
    private lazy var shadowBgView: UIImageView = {
        //: let v = UIImageView(image: UIImage.withView(name: "icon_userdetail_header_shadow"))
        let v = UIImageView(image: UIImage.withView(name: (str_shadowHaveValue.lowercased() + "_user" + str_transactionName.lowercased() + str_toContent.replacingOccurrences(of: "image", with: "l") + "_head" + String(str_loadData.prefix(4)) + "hadow")))
        //: return v
        return v
        //: }()
    }()
    ...
    private lazy var vipBgView: UIImageView = {
        ...
        v.frame = CGRect(x: 0, y: kLet_messageData - 15, width: kLet_scaleName, height: 15)
        //: return v
        return v
        //: }()
    }()
    ...
    private lazy var loungeImgV: UIImageView = {
        ...
        img.image = UIImage.withView(name: (String(str_sizeName) + str_centerText.replacingOccurrences(of: "change", with: "ng")))
        //: return img
        return img
        //: }()
    }()
    ...
    private lazy var officalImgV: UIButton = {
        ...
        img.setTitle((String(str_modelAspectValue.suffix(7)) + str_theName.replacingOccurrences(of: "view", with: "l")).localized, for: .normal)
    ...
    private lazy var onlineImgV: MediaControl = {
    ...
    private lazy var liveView: AlongView = {
        ...
        v.tapGestureBlock = { [weak self] in
            ...
            guard let self = self else { return }
            //: IndoorsPushManager.share.func_audiencePushToLiveRoomVC(uid: self.userInfoModel.uid, enterType: .userDetail)
            IndoorsPushManager.share.removeType(uid: self.userInfoModel.uid, enterType: .userDetail)
        }
        //: return v
        return v
        //: }()
    ...
    private lazy var reViewingLB: UILabel = {
        ...
        lb.text = (String(str_infoModelContent) + str_lineName.replacingOccurrences(of: "need", with: "g")).localized
        //: lb.textColor = .white
        lb.textColor = .white
        //: lb.backgroundColor = UIColor.init(hex: "#FF506D")
        lb.backgroundColor = UIColor(hex: (String(str_itemEndingValue.suffix(7))))
    ...
    lazy var lastLoginLab: UILabel = {
        ...
        lb.font = .conversationSize(type: .Medium, fontSize: 12)
        //: lb.textColor = .white
        lb.textColor = .white
        //: return lb
        return lb
    ...
    private lazy var intimateBtn: MediaControl = {
        //: let btn = TalkingButton()
        let btn = MediaControl()
        //: btn.setImage(UIImage.withView(name: "icon_user_detail_intimate_header"), for: .normal)
        btn.setImage(UIImage.withView(name: String(bytes: str_playValue.map{veryViewUser(source: $0)}, encoding: .utf8)!), for: .normal)
        //: btn.isHidden = true
        btn.isHidden = true
        //: btn.addTarget(self, action: #selector(intimateBtnClick), for: .touchUpInside)
        btn.addTarget(self, action: #selector(simulation), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension LabelBannerDelegate {
    /// 查看视频
    //: private func goToVideo() {
    private func priceByTap() {
        //: let vc = TalkingMomentVideoVC.init(videoPath: self.userInfoModel.videoUrl)
        let vc = UnheardOfViewDelegate(videoPath: self.userInfoModel.videoUrl)
        //: if WatercourseThen.share.loginUid != self.userInfoModel.uid {
        if WatercourseThen.share.loginUid != self.userInfoModel.uid {
    ...
    private func cineCamera(_ index: Int) {
        ...
        let vc = EleventhHourPhotosVc(momentModel: currenModel, index: index, type: .normal)
        //: self.currentViewController()?.navigationController?.pushViewController(vc, animated: true)
        self.toController()?.navigationController?.pushViewController(vc, animated: true)
    }
    ...
    @objc func simulation() {
        ...
        let url = AdErrorReactiveCompatible.viewType(urlType: .Intimate) + (String(str_giftTitle) + String(str_filterNextText.prefix(2))) + "\(self.userInfoModel.uid)"
...
extension LabelBannerDelegate: JXBannerDataSource {
    ...
    func jxBanner(_: JXBannerType) -> (JXBannerCellRegister) {
        ...
        return JXBannerCellRegister(type: SubPlayerDelegate.self, reuseIdentifier: (String(str_infoTitle.prefix(4)) + "rDet" + String(str_modelName.suffix(6)) + "derI" + String(str_frameViewValue.prefix(7))))
    }

    //: func jxBanner(_ banner: JXBannerType, cellForItemAt index: Int, cell: UICollectionViewCell) -> UICollectionViewCell {
    func jxBanner(_: JXBannerType, cellForItemAt index: Int, cell: UICollectionViewCell) -> UICollectionViewCell {
        //: let bannerCell = cell as! TUserDetailHeaderItemCell
        let bannerCell = cell as! SubPlayerDelegate
        //: let urlStr = self.dataArray[index]
        let urlStr = self.dataArray[index]

        //: if index == 0 && userInfoModel.sex == Gender.female.rawValue && userInfoModel.videoUrl.count>1 {
        if index == 0 && userInfoModel.sex == PushDownStackScalarLiteral.female.rawValue && userInfoModel.videoUrl.count > 1 { // 视频
            //: bannerCell.setVideoView()
            bannerCell.videoLocal()
            //: bannerCell.configModel(videoUrl: userInfoModel.videoUrl, imgUrl: userInfoModel.cover)
            bannerCell.videoModelConfigUrl(videoUrl: userInfoModel.videoUrl, imgUrl: userInfoModel.cover)
            ...
            bannerCell.deleteShared()
            //: bannerCell.bgImgView.setUrlImage(urlStr: urlStr, placeImg: UIImage.placeSquareBigImgBanner())
            bannerCell.bgImgView.optionsFinish(urlStr: urlStr, placeImg: UIImage.themeMapBanner())
        }
    ...
    func jxBanner(_: JXBannerType, centerIndex: Int, centerCell _: UICollectionViewCell) {
        //: guard userInfoModel.uid == WatercourseThen.share.loginUid else {
        guard userInfoModel.uid == WatercourseThen.share.loginUid else {
            //: return
            return
        }
    ...
    func jxBanner(pageControl _: JXBannerType, numberOfPages _: Int, coverView: UIView, builder: JXBannerPageControlBuilder) -> JXBannerPageControlBuilder {
        ...
        pageControl.activeColor = UIColor(hex: (String(str_voiceValue)))!
        //: pageControl.inactiveColor = UIColor(hex: "#BDB8B5")!
        pageControl.inactiveColor = UIColor(hex: (String(str_listReloadWhiteName)))!
...
extension LabelBannerDelegate: JXBannerDelegate {
    ...
    public func jxBanner(_: JXBannerType, didSelectItemAt index: Int) {
        //: if index == 0 && userInfoModel.sex == Gender.female.rawValue && userInfoModel.videoUrl.count>1 {
        if index == 0 && userInfoModel.sex == PushDownStackScalarLiteral.female.rawValue && userInfoModel.videoUrl.count > 1 {
            //: goToVideo()
            priceByTap()
            ...
            if userInfoModel.sex == PushDownStackScalarLiteral.female.rawValue && userInfoModel.videoUrl.count > 1 && curren > 0 {
                //: curren -= 1
                curren -= 1
            }
            //: goToPhoto(curren)
...
extension LabelBannerDelegate {
    ...
    func tap(_ userModel: TalkingWhiteTransformable) {
        ...
        if userModel.sex == PushDownStackScalarLiteral.female.rawValue && userModel.videoUrl.count > 1 {
        ...
        bannerView.reloadView()
        // vip
        //: let normalImg = UIImage.withView(name: "head_detail_bottom").withTintColor(.white)
        let normalImg = UIImage.withView(name: (String(str_videoTitle) + String(str_topClearCaseText))).withTintColor(.white)
        //: if userModel.loungePlus {
        if userModel.loungePlus {
            //: if let vipModel = WatercourseThen.share.appUserConfigMode.vipSetting.filter({$0.vipSkinId == userModel.vipSkinId}).first {
            if let vipModel = WatercourseThen.share.appUserConfigMode.vipSetting.filter({ $0.vipSkinId == userModel.vipSkinId }).first {
                //: vipBgView.setUrlImage(urlStr: vipModel.vipSkinTop, placeImg: normalImg)
                vipBgView.optionsFinish(urlStr: vipModel.vipSkinTop, placeImg: normalImg)
            }
            //: } else {
        } else {
        ...
        self.nicknameLab.textColor = userModel.loungePlus ? .toUser() : .white
        ...
        if userModel.intimateUrl.count > 0 {
            ...
            intimateImgV.ofData(urlStr: userModel.intimateUrl)
        }
        // 在线状态
        ...
        if userModel.livePlayUrl.count > 0 {
            ...
            let image = UIImage.dueDate(color: UIColor(hex: (String(str_resignCountAlongData.prefix(7))))!, size: CGSize(width: 8, height: 8))
            //: onlineImgV.setImage(image.iconSize(), for: .normal)
            onlineImgV.setImage(image.iconSize(), for: .normal)
            //: onlineImgV.setTitle("Live".localized, for: .normal)
            onlineImgV.setTitle((String(str_barValue)).localized, for: .normal)
            ...
            let image = UIImage.dueDate(color: UIColor(hex: (String(str_locationValue.prefix(7))))!, size: CGSize(width: 8, height: 8))
            //: onlineImgV.setImage(image.iconSize(), for: .normal)
            onlineImgV.setImage(image.iconSize(), for: .normal)
            //: onlineImgV.setTitle("Online".localized, for: .normal)
            onlineImgV.setTitle((String(str_hiddenEdgeData)).localized, for: .normal)
            ...
            let image = UIImage.dueDate(color: UIColor(hex: (String(str_tableName.prefix(7))))!, size: CGSize(width: 8, height: 8))
            //: onlineImgV.setImage(image.iconSize(), for: .normal)
            onlineImgV.setImage(image.iconSize(), for: .normal)
            //: onlineImgV.setTitle("busy".localized, for: .normal)
            onlineImgV.setTitle((str_objectText.replacingOccurrences(of: "user", with: "sy")).localized, for: .normal)
            //: } else {
        } else {
        ...
        // 直播
        //: if WatercourseThen.share.loginUid != userModel.uid &&
        if WatercourseThen.share.loginUid != userModel.uid,
        ...
        if liveView.isHidden == false {
            ...
            liveView.deadlineUrl(liveUrl: userModel.livePlayUrl)
        }
    }
    ...
    private func afterSession() {
        //: liveView.snp.makeConstraints { make in
        liveView.snp.makeConstraints { make in
            //: make.trailing.equalToSuperview()
            make.trailing.equalToSuperview()
            //: make.top.equalTo(StatusBarHeight+80)
            make.top.equalTo(kLet_environmentContent + 80)
        ...
        reViewingLB.snp.makeConstraints { make in
            ...
            make.top.equalToSuperview().offset(kLet_environmentContent + 15)
