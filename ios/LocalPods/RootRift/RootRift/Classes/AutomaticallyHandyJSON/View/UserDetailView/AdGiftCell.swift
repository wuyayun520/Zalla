...
fileprivate let str_modelColorValue:[UInt8] = [0xe8,0xef,0xe8,0xf5,0xa9,0xe2,0xee,0xe5,0xe4,0xf3,0xbb,0xa8,0xa1,0xe9,0xe0,0xf2,0xa1,0xef,0xee,0xf5,0xa1,0xe3,0xe4,0xe4,0xef,0xa1,0xe8,0xec,0xf1,0xed,0xe4,0xec,0xe4,0xef,0xf5,0xe4,0xe5]

/*: "Gifts received" :*/
fileprivate let str_actualData:[Character] = ["G","i","f","t","s"," ","r"]
fileprivate let str_touchTitle:String = "ecerendered"
...
class AdGiftCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_modelColorValue.map{$0^129}, encoding: .utf8)!)
    }
    ...
    private lazy var titleLab: UILabel = {
        ...
        lb.text = (String(str_actualData) + str_touchTitle.replacingOccurrences(of: "render", with: "iv")).localized
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        collect.register(AutomaticallyReactiveCompatible.self, forCellWithReuseIdentifier: AutomaticallyReactiveCompatible.className())
        //: return collect
        return collect
        //: }()
    }()
...
extension AdGiftCell: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: AutomaticallyReactiveCompatible.className(), for: indexPath) as! AutomaticallyReactiveCompatible
        //: let model: TalkingUserReceivedGiftModel = self.giftsDataArray[indexPath.row]
        let model: UserGiftModel = self.giftsDataArray[indexPath.row]
        //: cell.configGiftItemCellWithData(giftModel: model, isNewProfile)
        cell.upward(giftModel: model, isNewProfile)
        //: return cell
        return cell
    }
...
extension AdGiftCell {
    //: private func setupSubviews() {
    private func topSubviews() {
