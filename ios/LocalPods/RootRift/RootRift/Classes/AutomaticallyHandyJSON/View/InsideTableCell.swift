...
fileprivate let str_labelBackgroundData:[UInt8] = [0x8e,0x89,0x8e,0x93,0xcf,0x84,0x88,0x83,0x82,0x95,0xdd,0xce,0xc7,0x8f,0x86,0x94,0xc7,0x89,0x88,0x93,0xc7,0x85,0x82,0x82,0x89,0xc7,0x8e,0x8a,0x97,0x8b,0x82,0x8a,0x82,0x89,0x93,0x82,0x83]

private func channelPhoto(title num: UInt8) -> UInt8 {
    return num ^ 231
}

/*: "btn_me_edit" :*/
fileprivate let str_miniValue:String = "equal timebtn_"

/*: "Add" :*/
fileprivate let str_giftSourceData:String = "Addself false"
...
class InsideTableCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_labelBackgroundData.map{channelPhoto(title: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var editImag: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.withView(name: (String(str_miniValue.suffix(4)) + "me_edit")))
    ...
    lazy var detailLB: UILabel = {
        ...
        lb.textColor = UIColor.obtrudeUpon()
        //: lb.textAlignment = .right
        lb.textAlignment = .right
        //: lb.text = "Add".localized
        lb.text = (String(str_giftSourceData.prefix(3))).localized
        //: lb.isHidden = true
        lb.isHidden = true
        //: return lb
        return lb
...
extension InsideTableCell {
    //: func setCellMessage(titile: String, iconStr: String, isShowDet:Bool) {
    func whiteInfo(titile: String, iconStr: String, isShowDet: Bool) {
        //: titleBLB.text = titile
        titleBLB.text = titile
        //: iconImg.image = UIImage.withView(name: iconStr)
        iconImg.image = UIImage.withView(name: iconStr)
