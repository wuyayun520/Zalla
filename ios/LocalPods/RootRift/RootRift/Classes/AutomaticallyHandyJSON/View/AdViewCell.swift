...
fileprivate let str_itemData:[UInt8] = [0xc1,0xc6,0xc1,0xcc,0x80,0xbb,0xc7,0xbc,0xbd,0xca,0x92,0x81,0x78,0xc0,0xb9,0xcb,0x78,0xc6,0xc7,0xcc,0x78,0xba,0xbd,0xbd,0xc6,0x78,0xc1,0xc5,0xc8,0xc4,0xbd,0xc5,0xbd,0xc6,0xcc,0xbd,0xbc]

fileprivate func courseOfAction(block num: UInt8) -> UInt8 {
...
/*: "btn_me_edit" :*/
fileprivate let str_makeText:String = "self textbtn_me"
fileprivate let str_moreName:String = "active medium other_edit"
...
class AdViewCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_itemData.map{courseOfAction(block: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var editImag: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.withView(name: (String(str_makeText.suffix(6)) + String(str_moreName.suffix(5)))))
...
extension AdViewCell {
    //: func setCellMessage(titile: String, row: Int, isLast: Bool) {
    func majorityLast(titile: String, row: Int, isLast: Bool) {
    ...
    func capabilityClick(detail: String) {
    ...
    func enterArrows() {
        ...
        titleBLB.font = UIFont.conversationSize(type: .Medium, fontSize: 15)
        //: detailLB.font = UIFont.pingfangFont(type: .Medium, fontSize: 15)
        detailLB.font = UIFont.conversationSize(type: .Medium, fontSize: 15)
        //: editImag.isHidden = false
        editImag.isHidden = false
