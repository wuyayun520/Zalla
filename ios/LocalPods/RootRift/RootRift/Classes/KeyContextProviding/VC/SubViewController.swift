...
fileprivate let str_attributeData:[Character] = ["T","a","l","k","i","n","g","A","r","e","a","C","o","d","e","C","h","o"]
fileprivate let str_loadData:[Character] = ["i","c","e"]
fileprivate let str_makeName:String = "CellIDequal var"

/*: "init(coder:) has not been implemented" :*/
fileprivate let str_infoValue:[UInt8] = [0x9e,0x99,0x9e,0x83,0xdf,0x94,0x98,0x93,0x92,0x85,0xcd,0xde,0xd7,0x9f,0x96,0x84,0xd7,0x99,0x98,0x83,0xd7,0x95,0x92,0x92,0x99,0xd7,0x9e,0x9a,0x87,0x9b,0x92,0x9a,0x92,0x99,0x83,0x92,0x93]

private func inSucceed(stream num: UInt8) -> UInt8 {
    return num ^ 247
}

/*: "Select Country Code" :*/
fileprivate let str_textViewValue:String = "Selectlet type cell index"
fileprivate let str_blockName:String = "manager scale reject view notry Cod"
fileprivate let str_buttonData:String = "player"

/*: "#F4F6FA" :*/
fileprivate let str_makeData:String = "#F4F6kit make from"
fileprivate let str_collectionValue:String = "Freport"
...
class SubViewController: MusicViewController {
    //: public var backCountryCode: ((TalkingAreaModel) -> Void)?
    public var backCountryCode: ((AutomaticallyMeasurable) -> Void)?

    //: private let TalkingAreaCodeChoiceCellID = "TalkingAreaCodeChoiceCellID"
    private let TalkingAreaCodeChoiceCellID = (String(str_attributeData) + String(str_loadData) + String(str_makeName.prefix(6)))
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_infoValue.map{inSucceed(stream: $0)}, encoding: .utf8)!)
    }
    ...
    override func viewDidLoad() {
        ...
        self.title = (String(str_textViewValue.prefix(6)) + " Count" + String(str_blockName.suffix(6)) + str_buttonData.replacingOccurrences(of: "player", with: "e")).localized
    ...
    lazy var tableView: UITableView = {
        ...
        tableView.register(AtChoiceCell.classForCoder(), forCellReuseIdentifier: TalkingAreaCodeChoiceCellID)
        ...
        tableView.backgroundColor = UIColor(hex: (String(str_makeData.prefix(5)) + str_collectionValue.replacingOccurrences(of: "report", with: "A")))
        //: return tableView
        return tableView
        //: }()
    }()
...
extension SubViewController {
    ...
    private func gestureWith() {
        ...
        for areaModel: AutomaticallyMeasurable in arr {
        ...
        for index in 0 ..< sectionNumb {
            ...
            let sortArr = collation.sortedArray(from: tempArr, collationStringSelector: #selector(getter: AutomaticallyMeasurable().areaName))
...
extension SubViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        if sectionArray.count > section {
            ...
            let array: [AutomaticallyMeasurable] = sectionArray[section] as! [AutomaticallyMeasurable]
            //: return array.count
            return array.count
        }
        //: return 0
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell: AtChoiceCell = tableView.dequeueReusableCell(withIdentifier: TalkingAreaCodeChoiceCellID, for: indexPath) as! AtChoiceCell
        //: let array: [TalkingAreaModel] = sectionArray[indexPath.section] as! [TalkingAreaModel]
        let array: [AutomaticallyMeasurable] = sectionArray[indexPath.section] as! [AutomaticallyMeasurable]
        //: cell.func__updateUIWithModel(areaModel: array[indexPath.row])
        cell.collectionReleaseModel(areaModel: array[indexPath.row])
    ...
    func tableView(_: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        headView.frame = CGRect(x: 0, y: 0, width: kLet_scaleName, height: 30)
        ...
        label.frame = CGRect(x: 15, y: 0, width: kLet_scaleName - 30, height: 30)
