...
public struct Config {
    ...
    public static var initialMenuStyle: QualityMenuStyle?

    
    //: public struct MenuCellConfig {        
    public struct MediaTableDHoteConfig {        
    ...
    public struct TableOfTextsConfig {
