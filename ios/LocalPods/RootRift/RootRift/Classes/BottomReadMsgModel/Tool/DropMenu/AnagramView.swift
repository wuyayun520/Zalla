...
fileprivate let str_equalGroupValue:[UInt8] = [0xfc,0xfb,0xfc,0xe1,0xbd,0xf6,0xfa,0xf1,0xf0,0xe7,0xaf,0xbc,0xb5,0xfd,0xf4,0xe6,0xb5,0xfb,0xfa,0xe1,0xb5,0xf7,0xf0,0xf0,0xfb,0xb5,0xfc,0xf8,0xe5,0xf9,0xf0,0xf8,0xf0,0xfb,0xe1,0xf0,0xf1]

private func placeTitle(make num: UInt8) -> UInt8 {
    return num ^ 149
}
...
class AnagramView: UITableViewCell {
    //: lazy var menuImageView: UIImageView = self.makeMenuImageView()
    lazy var menuImageView: UIImageView = self.enableReport()
    //: lazy var menuTitleLabel: UILabel = self.makeMenuTitleLable()
    lazy var menuTitleLabel: UILabel = self.playKey()
    ...
    var dropMenuStyle: QualityMenuStyle? {
        //: didSet {
        didSet {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_equalGroupValue.map{placeTitle(make: $0)}, encoding: .utf8)!)
    }
    ...
    private func enableReport() -> UIImageView {
    ...
    private func kickoff() {
        ...
        lineLayer.strokeColor = UIColor.nearComponentRgba(230, 230, 230, 1.0).cgColor
