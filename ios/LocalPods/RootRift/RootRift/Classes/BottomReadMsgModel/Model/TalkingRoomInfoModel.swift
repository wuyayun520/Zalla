...
/*: "id" :*/
fileprivate let str_upStatusAppTitle:[Character] = ["i","d"]
...
enum FactoryValueConvertible: Int {
    //: case normal = 1
    case normal = 1 // 普通礼物
    //: case myStery  = 2
    case myStery = 2 // 盲盒礼物
...
struct LogTransformable: HandyJSON {
    //: var num: Int?
    var num: Int? /// 数量
    //: var tag: String?
    var tag: String? /// 说明
...
struct FailMediaHandyJSON: HandyJSON {
