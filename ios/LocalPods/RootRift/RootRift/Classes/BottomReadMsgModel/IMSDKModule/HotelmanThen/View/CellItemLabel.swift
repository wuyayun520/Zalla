...
fileprivate let str_colorData:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]
...
class CellItemLabel: UIView {
    ...
    private var giftSendItem = [LogTransformable()]
    ...
    override init(frame: CGRect) {
        ...
        super.init(frame: frame)
        //: self.setupSubviews()
        self.setupWithinCapture()
    }

    //: required init?(coder: NSCoder) {
    required init?(coder _: NSCoder) {
        //: fatalError("init(coder:) has not been implemented")
        fatalError(String(bytes: str_colorData.reversed(), encoding: .utf8)!)
    }
    ...
    func white(attributedText: NSAttributedString) {
        ...
        shadow.shadowColor = UIColor.obtrudeUpon()
    ...
    func pathDisappear(frame: CGRect) {
        //: self.frame = frame
        self.frame = frame
    ...
    private lazy var gradientLayer: CAGradientLayer = {
        ...
        lay.colors = [UIColor.nearComponentRgba(255, 232, 72, 1).cgColor, // 浅黄
                      //: UIColor.RGBA(253, 170, 52, 1).cgColor
                      UIColor.nearComponentRgba(253, 170, 52, 1).cgColor, // 深黄
        ]
...
extension CellItemLabel {
    ...
    private func setupWithinCapture() {
