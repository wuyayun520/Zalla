...
/*: "#E6BD8B" :*/
fileprivate let str_addValue:String = "#E6BD8Bgift height background view"

/*: "+ :*/
fileprivate let str_domainData:String = "+"

/*: "get json error" :*/
fileprivate let str_recordName:String = "get jload way make"
fileprivate let str_viewValue:String = "eresistanceresistanceo"
fileprivate let str_toTitle:String = "main"
...
class PointView: UIView {
    ...
    private lazy var pointLab: UILabel = {
        ...
        lab.font = UIFont.conversationSize(type: .Semibold, fontSize: 24)
        //: lab.textColor = UIColor.init(hex: "#E6BD8B")
        lab.textColor = UIColor(hex: (String(str_addValue.prefix(7))))
...
extension PointView {
    ...
    func dataBackground(point: String, isminiStr: Bool = false) {
        ...
        let attributes = [.foregroundColor: UIColor(hex: (String(str_addValue.prefix(7))))!, .font: UIFont.conversationSize(type: .Semibold, fontSize: isminiStr ? 15 : 24)] as [NSAttributedString.Key: Any]
        ...
        let attributes2 = [.foregroundColor: UIColor(hex: (String(str_addValue.prefix(7))))!, .font: UIFont.conversationSize(type: .Semibold, fontSize: 14)] as [NSAttributedString.Key: Any]
        ...
        do {
            ...
            var url = StreamReactiveCompatible.default.picName(type: .VideoCall_femalePoint)
            ...
            if GazetteThen.share.interfaceLang == AssemblyPlantMirrorPath.ar.rawValue {
                ...
                url = StreamReactiveCompatible.default.picName(type: .videoCall_femalePoint_ar)
                ...
                url = StreamReactiveCompatible.default.picName(type: .videoCall_femalePoint_es)
                ...
                url = StreamReactiveCompatible.default.picName(type: .videoCall_femalePoint_pt)
            }
            ...
            printLog(message: (String(str_recordName.prefix(5)) + "son " + str_viewValue.replacingOccurrences(of: "resistance", with: "r") + str_toTitle.replacingOccurrences(of: "main", with: "r")))
        }
    }
}
