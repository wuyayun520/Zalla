...
fileprivate let str_appData:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "icon_livetc_warn" :*/
fileprivate let str_screenData:[Character] = ["i","c","o","n","_","l","i","v","e","t","c","_","w","a","r","n"]

/*: "OK" :*/
fileprivate let str_layerName:[Character] = ["O","K"]
...
class NoAlertView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_appData.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var topIcon: UIImageView = {
        ...
        let iamg = UIImageView()
        //: iamg.image = UIImage.withView(name: "icon_livetc_warn")
        iamg.image = UIImage.withView(name: (String(str_screenData)))
    ...
    private lazy var contentLab: UILabel = {
        ...
        lab.textAlignment = .center
        //: lab.text = WatercourseThen.share.appUserConfigMode.blockCameraPopupContent
        lab.text = WatercourseThen.share.appUserConfigMode.blockCameraPopupContent
        //: lab.numberOfLines = 0
        lab.numberOfLines = 0
        //: return lab
    ...
    private lazy var closeBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(get), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
