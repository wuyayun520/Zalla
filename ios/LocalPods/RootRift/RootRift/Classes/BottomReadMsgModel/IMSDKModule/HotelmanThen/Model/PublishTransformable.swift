...
let kLet_transformTitle = actualWidth(w: 275)
//: let VideoMsgTableViewHeight =  actualWidth(w: 200)
let kLet_senseFailName = actualWidth(w: 200)
//: let VideocellLineSpeing = 3
let kLet_screenStatusName = 3 /// cell间距

//: struct TalkingVideoCallDanmuModel: HandyJSON {
struct PublishTransformable: HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var senderUid = ""
    var senderUid = ""
