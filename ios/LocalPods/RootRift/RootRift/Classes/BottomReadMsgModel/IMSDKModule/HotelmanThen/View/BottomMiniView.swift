...
fileprivate let str_currentData:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "icon_mini_voice_end" :*/
fileprivate let str_balanceItemTitle:[Character] = ["i","c","o","n","_","m","i","n","i","_","v","o","i","c","e","_","e","n","d"]

/*: "#F95151" :*/
fileprivate let str_onValue:String = "view info#F9515"
fileprivate let str_appSizeValue:[Character] = ["1"]

/*: "End of call" :*/
fileprivate let str_backgroundText:String = "type content game labEnd o"

/*: "img_home_shadow_icon" :*/
fileprivate let str_intimateTitle:String = "cell button var imageimg_ho"
fileprivate let str_toData:[Character] = ["w","_","i","c","o","n"]
...
class BottomMiniView: RubricMiniView {
    // 小窗口通话状态
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_currentData.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var statusIcon: UIImageView = {
        //: let img = UIImageView()
        let img = UIImageView()
        //: img.image = UIImage.withView(name: "icon_mini_voice_end")
        img.image = UIImage.withView(name: (String(str_balanceItemTitle)))
    ...
    private lazy var desLab: UILabel = {
        ...
        lab.textColor = UIColor(hex: (String(str_onValue.suffix(6)) + String(str_appSizeValue)))
        ...
        lab.text = (String(str_backgroundText.suffix(5)) + "f call").localized
    ...
    private lazy var shadowImg: UIImageView = {
        ...
        img.image = UIImage.withView(name: (String(str_intimateTitle.suffix(6)) + "me_shado" + String(str_toData)))
...
extension BottomMiniView {
    /// 构建视频小窗口
    //: static func buildVideoMiniView() -> TalkingVideoMiniView {
    static func searched() -> BottomMiniView {
        //: let view = TalkingVideoMiniView(frame: .zero)
        let view = BottomMiniView(frame: .zero)
