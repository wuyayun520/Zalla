...
// __CLOSE_PRINT__
//
//  PerformanceTransformable.swift
//  AbroadTalking
//
...
class PerformanceTransformable: HandyJSON {
    //: var roomId = ""                           // trtc房间号
    var roomId = "" // trtc房间号
    //: var streamerInfo = TalkingStreamerInfo()
    var streamerInfo = PreferModelType() // 主播信息
    //: var livePlayUrl = ""                      // CDN旁路直播拉流地址
    var livePlayUrl = "" // CDN旁路直播拉流地址
    //: var gameList = [TalkingGameListModel]()
    var gameList = [BecomeNameHandyJSON]() // 游戏列表
...
class PreferModelType: HandyJSON {
    //: var uid = 0
    var uid = 0
    //: var headPic = ""
    var headPic = ""
...
class BecomeNameHandyJSON: HandyJSON {
    //: var name = ""
    var name = ""
    //: var icon = ""
    var icon = ""
