...
fileprivate let str_canFinishData:[UInt8] = [0x78,0x7d,0x78,0x83,0x37,0x72,0x7e,0x73,0x74,0x81,0x49,0x38,0x2f,0x77,0x70,0x82,0x2f,0x7d,0x7e,0x83,0x2f,0x71,0x74,0x74,0x7d,0x2f,0x78,0x7c,0x7f,0x7b,0x74,0x7c,0x74,0x7d,0x83,0x74,0x73]

fileprivate func equalAppCustom(count num: UInt8) -> UInt8 {
...
class AlongView: RubricMiniView {
    // 播放结束Block
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_canFinishData.map{equalAppCustom(count: $0)}, encoding: .utf8)!)
    }
...
extension AlongView {
    ...
    func deadlineUrl(liveUrl: String) {
...
extension AlongView: TXLivePlayListener {
