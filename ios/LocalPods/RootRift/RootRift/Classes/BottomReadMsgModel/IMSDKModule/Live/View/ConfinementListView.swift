...
fileprivate let str_topValue:[UInt8] = [0x2b,0x2c,0x2b,0x36,0x6a,0x21,0x2d,0x26,0x27,0x30,0x78,0x6b,0x62,0x2a,0x23,0x31,0x62,0x2c,0x2d,0x36,0x62,0x20,0x27,0x27,0x2c,0x62,0x2b,0x2f,0x32,0x2e,0x27,0x2f,0x27,0x2c,0x36,0x27,0x26]

private func addBlock(to num: UInt8) -> UInt8 {
    return num ^ 66
}

/*: "Online Users" :*/
fileprivate let str_hiddenData:[Character] = ["O","n","l","i","n","e"," ","U"]
fileprivate let str_logData:String = "actioneraction"

/*: "AreaView" :*/
fileprivate let str_buttonOuterText:String = "effect makeTalkin"
fileprivate let str_videoKindValue:String = "oomOnlimodel var jump"
fileprivate let str_toMakeTitle:String = "neLiscenter party across image"
...
class ConfinementListView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_topValue.map{addBlock(to: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var dismissBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(positionOpenClick), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var tipsLb: UILabel = {
        ...
        lb.text = (String(str_hiddenData) + str_logData.replacingOccurrences(of: "action", with: "s")).localized
        //: return lb
        return lb
        //: }()
    }()
...
extension ConfinementListView {
    ...
    private func face() {
        ...
        OrganicStructureReactiveCompatible().addButton(chatGroupId: self.chatGroupId) { succeed, result, _ in
            ...
            if succeed {
                ...
                if let datas = Array<DateMeasurable>.deserialize(from: array as? Array) {
...
extension ConfinementListView: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let identifier = (String(str_buttonOuterText.suffix(6)) + "gLiveR" + String(str_videoKindValue.prefix(7)) + String(str_toMakeTitle.prefix(5)) + "tCell")
        ...
        cell?.upFinish(model: self.DataSource[indexPath.row], index: indexPath.row)
        //: return cell!
        return cell!
    }
...
extension ConfinementListView {
    ...
    @objc private func positionOpenClick() {
        //: dismiss()
        executeDismiss()
    }
    ...
    func exhibitId(chatGroupId: String) {
