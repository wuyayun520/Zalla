...
/*: "id" :*/
fileprivate let str_termsText:String = "irecord"

/*: "num" :*/
fileprivate let str_onData:String = "nuawake"
...
// __CLOSE_PRINT__
//
//  EnableLabelTransformable.swift
//  AbroadTalking
//
...
@objc public enum AppealMagnitude: Int {
    //: case normal  = 1
    case normal = 1 // 普通礼物
    //: case myStery = 2
    case myStery = 2 // 盲盒礼物
...
struct EnableLabelTransformable: HandyJSON {
    //: init() {
    init() {}
    ...
    var animationTimes = 0
    //: var showType = 0
    var showType = 0 /// AppealMagnitude
    ...
    mutating func untilRange(giftNum: Int) {
        //: self.num = giftNum
        self.num = giftNum
    }
}
...
struct MixedAnimatModel: HandyJSON {
    //: init() {
    init() {}
    ...
    mutating func mapping(mapper: HelpingMapper) {
        ...
        mapper <<<
            //: self.giftNum <-- "num"
            self.giftNum <-- (str_onData.replacingOccurrences(of: "awake", with: "m"))
    }
}
