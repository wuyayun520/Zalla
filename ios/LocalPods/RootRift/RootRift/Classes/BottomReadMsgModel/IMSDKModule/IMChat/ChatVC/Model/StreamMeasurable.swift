...
@objcMembers class StreamMeasurable: NSObject, HandyJSON {
    //: var msgInfo: TalkingMsgInfoModel?
    var msgInfo: ColorInfoHandyJSON?
    //: var gift: TalkingMsgGiftModel?
    var gift: IndexMeasurable?
    //: var user: TalkingMsgUserModel?
    var user: ResultHandyJSON?
    //: var toUser: TalkingMsgToUserModel?
    var toUser: UserCurrentReactiveCompatible?
...
class ColorInfoHandyJSON: NSObject, HandyJSON {
    //: var msgId = ""
    var msgId = ""
    //: var content = ""
    var content = ""
...
class ResultHandyJSON: NSObject, HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var nickname = ""
    var nickname = ""
...
class UserCurrentReactiveCompatible: NSObject, HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var nickname = ""
    var nickname = ""
...
class IndexMeasurable: NSObject, HandyJSON {
    //: var iosEffect = ""
    var iosEffect = ""
    //: var animationTimes = ""
    var animationTimes = ""
