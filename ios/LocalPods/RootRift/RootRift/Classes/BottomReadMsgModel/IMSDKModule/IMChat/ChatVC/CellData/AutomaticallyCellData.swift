...
/*: _" :*/
fileprivate let str_imageValue:[Character] = ["_"]

/*: ".png" :*/
fileprivate let str_titleData:String = ".pngstring player ready raw"
...
//: @objcMembers public class AutomaticallyCellData: TalkingChatMsgBaseCellData {
@objcMembers public class AutomaticallyCellData: WriteRequestCellData {
    ...
    override public var msgModel: FrameJsonModel {
        ...
        set {
            ...
            if !self.msgModel.msgInfo.imageData.isEmptyString {
                ...
                self.imageData = UIImage.themeHide(imageData: self.msgModel.msgInfo.imageData)
            }
        }
    }
    ...
    static func blockEqual(image: UIImage) -> String {
        ...
        let filePath = (libraryPath as NSString).appendingPathComponent(kLet_seatContent)
        ...
        let interval = Date().timeIntervalSince1970 * 1000
        //: let imageName = "\(Int(interval))_" + WatercourseThen.share.loginUserMode.userID + ".png"
        let imageName = "\(Int(interval))_" + WatercourseThen.share.loginUserMode.userID + (String(str_titleData.prefix(4)))
        ...
        let imageData = UIImage.qualifyVideoSumSize(image, mentalPicture: 2 * 1024)
