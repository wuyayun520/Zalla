...
fileprivate let str_contentData:[UInt8] = [0xb1,0xb6,0xb1,0xac,0xf0,0xbb,0xb7,0xbc,0xbd,0xaa,0xe2,0xf1,0xf8,0xb0,0xb9,0xab,0xf8,0xb6,0xb7,0xac,0xf8,0xba,0xbd,0xbd,0xb6,0xf8,0xb1,0xb5,0xa8,0xb4,0xbd,0xb5,0xbd,0xb6,0xac,0xbd,0xbc]

private func byFalse(post num: UInt8) -> UInt8 {
    return num ^ 216
}

/*: "nav_back_black_nor" :*/
fileprivate let str_videoTitle:[Character] = ["n","a","v","_","b","a","c","k","_","b","l","a","c","k","_","n","o","r"]

/*: "btn_detail_more" :*/
fileprivate let str_infoGalleryData:String = "btn_detreturn female"
fileprivate let str_taskManagerInTitle:String = "shared height return managerail_more"

/*: "btn_chat_videocall" :*/
fileprivate let str_managerValue:String = "info leading let infobtn_ch"
fileprivate let str_afterName:String = "ecropall"

/*: "icon_lounge" :*/
fileprivate let str_makeName:String = "to selficon_lo"
fileprivate let str_femalePlusData:String = "uendge"

/*: "Official" :*/
fileprivate let str_imageText:String = "data addOffi"

/*: "Online List" :*/
fileprivate let str_cellTitle:String = "file view view color viewOnline"
fileprivate let str_thirdName:[Character] = [" ","L","i","s","t"]

/*: "icon_privateChat_intimate" :*/
fileprivate let str_sureValue:String = "size task emptyicon_p"
fileprivate let str_modelMessageName:[Character] = ["t","e","C","h","a","t","_","i"]
fileprivate let str_filterTitle:String = "ntcreatemate"

/*: "#FF60B9" :*/
fileprivate let str_matchMethodName:String = "true cell source#FF60B"
fileprivate let str_equalTitle:[Character] = ["9"]

/*: "Customer Care Center" :*/
fileprivate let str_greetContent:[Character] = ["C","u","s","t","o","m","e","r"," ","C","a","r"]
fileprivate let str_toReValue:String = "majority"
fileprivate let str_successName:[Character] = [" ","C","e","n","t","e","r"]

/*: "#48FF1E" :*/
fileprivate let str_pushValue:String = "path image key equal lab#48FF1"
fileprivate let str_titleWhiteValue:String = "normal"

/*: "Online" :*/
fileprivate let str_withContent:String = "true let varOnlin"
fileprivate let str_saveContent:[Character] = ["e"]

/*: "#FF4B7F" :*/
fileprivate let str_hiddenText:[Character] = ["#","F","F","4","B","7","F"]

/*: "busy" :*/
fileprivate let str_insertValue:[Character] = ["b","u","s","y"]

/*: "+ :*/
fileprivate let str_bottomValue:String = "execute"

/*: "get json error" :*/
fileprivate let str_textContent:String = "get jsotype user self path"
fileprivate let str_equalChangeData:String = "n errortrue to other model"

/*: "transform.rotation" :*/
fileprivate let str_imageIndexValue:[Character] = ["t","r","a","n","s","f","o","r","m",".","r","o","t"]
fileprivate let str_toCommonHeightValue:[Character] = ["a","t","i","o","n"]

/*: "transform.scale" :*/
fileprivate let str_currentData:[Character] = ["t","r","a","n","s","f","o","r","m",".","s","c","a","l","e"]

/*: "zoom&shake" :*/
fileprivate let str_rawVideoData:String = "label index self elsezoom&sh"
fileprivate let str_scaleCollectionData:String = "avaluee"
...
class ManagingDirectorReactiveCompatible: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_contentData.map{byFalse(post: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var backButton: UIButton = {
        ...
        let img = UIImage.withView(name: (String(str_videoTitle))).withRenderingMode(.alwaysTemplate)
    ...
    lazy var moreButton: UIButton = {
        ...
        let img = UIImage.withView(name: (String(str_infoGalleryData.prefix(7)) + String(str_taskManagerInTitle.suffix(8)))).withRenderingMode(.alwaysTemplate)
        //: btn.setImage(img, for: .normal)
        btn.setImage(img, for: .normal)
        //: btn.tintColor = .white
        btn.tintColor = .white
    ...
    lazy var videoCallBtn: UIButton = {
        //: let btn = UIButton(type: .custom)
        let btn = UIButton(type: .custom)
        //: let img = UIImage.withView(name: "btn_chat_videocall").withRenderingMode(.alwaysTemplate)
        let img = UIImage.withView(name: (String(str_managerValue.suffix(6)) + "at_vid" + str_afterName.replacingOccurrences(of: "crop", with: "oc"))).withRenderingMode(.alwaysTemplate)
        //: btn.setImage(img, for: .normal)
        btn.setImage(img, for: .normal)
        //: btn.tintColor = .white
        btn.tintColor = .white
    ...
    lazy var loungeImgV: UIImageView = {
        ...
        img.image = UIImage.withView(name: (String(str_makeName.suffix(7)) + str_femalePlusData.replacingOccurrences(of: "end", with: "n")))
        //: img.isHidden = true
        img.isHidden = true
        //: return img
        return img
    ...
    lazy var officalImgV: UIButton = {
        ...
        img.toPop(color: UIColor.colorationPick(), forState: .normal)
        //: img.setTitle("Official".localized, for: .normal)
        img.setTitle((String(str_imageText.suffix(4)) + "cial").localized, for: .normal)
    ...
    lazy var onlineListBtn: UIButton = {
        ...
        btn.setTitle((String(str_cellTitle.suffix(6)) + String(str_thirdName)).localized, for: .normal)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var onlineStatusV: MediaControl = {
    ...
    private lazy var myBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(startMove), for: .touchUpInside)
    ...
    private lazy var userBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(picPlace), for: .touchUpInside)
        //: btn.imageView?.contentMode = .scaleAspectFill
        btn.imageView?.contentMode = .scaleAspectFill
        //: btn.isHidden = true
        btn.isHidden = true
    ...
    private lazy var intimateBtn: UIButton = {
        //: let btn = UIButton()
        let btn = UIButton()
        //: btn.setImage(UIImage.withView(name: "icon_privateChat_intimate"), for: .normal)
        btn.setImage(UIImage.withView(name: (String(str_sureValue.suffix(6)) + "riva" + String(str_modelMessageName) + str_filterTitle.replacingOccurrences(of: "create", with: "i"))), for: .normal)
        //: btn.isHidden = true
        btn.isHidden = true
    ...
    private lazy var intimateLB: UILabel = {
        ...
        lb.textColor = UIColor(hex: (String(str_matchMethodName.suffix(6)) + String(str_equalTitle)))
    ...
    private lazy var addIntimateLB: UILabel = {
        ...
        lb.font = UIFont.conversationSize(type: .Semibold, fontSize: 12)
        //: lb.isHidden = true
        lb.isHidden = true
...
extension ManagingDirectorReactiveCompatible {
    ...
    func butterflyEffectView() {
        ...
        if self.chatType == .service {
            ...
            titleLabel.text = (String(str_greetContent) + str_toReValue.replacingOccurrences(of: "majority", with: "e") + String(str_successName)).localized
            //: titleLabel.font = .pingfangFont(type: .Medium, fontSize: 18)
            titleLabel.font = .conversationSize(type: .Medium, fontSize: 18)
            //: titleLabel.textColor = .appTitleColor()
            titleLabel.textColor = .ending()
    ...
    func playModel() {
        ...
        if self.chatType == .service { // 官方客服
            ...
            let offset = FactoryShowThen.shared.direction == .leftToRight ? 22 : -22
    ...
    ///   - userModel: 用户信息
    ///   - isFrom: 列表控制器入口
    //: func private_updateNavView(userModel: MixedThen, isFrom: PrivateChatIsFromEnum) {
    func locationIn(userModel: MixedThen, isFrom: SubFromEnum) {
        ...
        if userModel.onlineStatus == 1 {
            ...
            let image = UIImage.dueDate(color: UIColor(hex: (String(str_pushValue.suffix(6)) + str_titleWhiteValue.replacingOccurrences(of: "normal", with: "E")))!, size: CGSize(width: 8, height: 8))
            //: onlineStatusV.setImage(image.iconSize(), for: .normal)
            onlineStatusV.setImage(image.iconSize(), for: .normal)
            //: onlineStatusV.setTitle("Online".localized, for: .normal)
            onlineStatusV.setTitle((String(str_withContent.suffix(5)) + String(str_saveContent)).localized, for: .normal)
            ...
            let image = UIImage.dueDate(color: UIColor(hex: (String(str_hiddenText)))!, size: CGSize(width: 8, height: 8))
            //: onlineStatusV.setImage(image.iconSize(), for: .normal)
            onlineStatusV.setImage(image.iconSize(), for: .normal)
            //: onlineStatusV.setTitle("busy".localized, for: .normal)
            onlineStatusV.setTitle((String(str_insertValue)).localized, for: .normal)
            //: } else {
        } else {
        ...
        titleLabel.textColor = userModel.loungePlus ? .toUser() : .white
        ...
        var videoCall = userModel.enableVideoCall
        //: if isFrom == .LiveRoom || WatercourseThen.share.appStatus == AppSkinStatus.special.rawValue {
        if isFrom == .LiveRoom || WatercourseThen.share.appStatus == PublishWidthTotal.special.rawValue {
            //: videoCall = false
            videoCall = false
        }
        //: if videoCall {
    ...
    /// - Parameters:
    ///   - userModel: 用户信息
    //: func private_updateIntimateNavView(userModel: MixedThen) {
    func raw(userModel: MixedThen) {
        ...
        userBtn.isHidden = false
        //: myBtn.setUrlImage(urlStr: WatercourseThen.share.loginUserMode.headPic ?? "")
        myBtn.setToAccomplishUpwards(urlStr: WatercourseThen.share.loginUserMode.headPic ?? "")
        //: userBtn.setUrlImage(urlStr: userModel.headPic)
        userBtn.setToAccomplishUpwards(urlStr: userModel.headPic)
    ...
    func equalNumberimate(intimate: Int) {
        //: let str  = "+\(intimate)"
        let str = "+\(intimate)"
        ...
        let attributes = [.foregroundColor: UIColor.white, .font: UIFont.conversationSize(type: .Semibold, fontSize: 12)] as [NSAttributedString.Key: Any]
        ...
        let url = StreamReactiveCompatible.default.picName(type: .Private_Chat_intimate)
        //: do {
        do {
            ...
            printLog(message: (String(str_textContent.prefix(7)) + String(str_equalChangeData.prefix(7))))
        }
    }
    ...
    @objc func startMove() {
        //: IndoorsPushManager.share.func__pushToUserDetailVC(uid: WatercourseThen.share.loginUserMode.userID)
        IndoorsPushManager.share.digitiserView(uid: WatercourseThen.share.loginUserMode.userID)
    }

    //: @objc func userIconClick() {
    @objc func picPlace() {
        //: IndoorsPushManager.share.func__pushToUserDetailVC(uid: userId)
        IndoorsPushManager.share.digitiserView(uid: userId)
    }
    ...
    @objc func speak() {
        ...
        let view = MusicResultDataSource(frame: CGRect(x: 0, y: 0, width: kLet_scaleName, height: kLet_environmentText))
        //: view.show()
        view.gestureApp()
    }
    ...
    func cellByLast() {
        ...
        let roate = CAKeyframeAnimation(keyPath: (String(str_imageIndexValue) + String(str_toCommonHeightValue)))
        ...
        let zoom = CAKeyframeAnimation(keyPath: (String(str_currentData)))
        ...
        videoCallBtn.layer.add(groupAnnimation, forKey: (String(str_rawVideoData.suffix(7)) + str_scaleCollectionData.replacingOccurrences(of: "value", with: "k")))
    }
}
