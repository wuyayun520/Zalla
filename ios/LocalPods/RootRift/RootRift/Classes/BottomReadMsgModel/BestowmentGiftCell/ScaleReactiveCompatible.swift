...
open class ScaleReactiveCompatible: UITextView {
    ...
    @IBInspectable open var placeholderColor: UIColor = ScaleReactiveCompatible.Constants.defaultiOSPlaceholderColor {
        //: didSet {
        didSet {
    ...
    private func joint() {
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(notViewComponent),
    ...
    @objc private func notViewComponent() {
