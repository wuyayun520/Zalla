...
/*: "#777777" :*/
fileprivate let str_backTitle:[Character] = ["#"]
fileprivate let str_pushData:String = "777777"

/*: "#333333" :*/
fileprivate let str_commitTitle:[Character] = ["#","3","3","3","3","3","3"]

/*: "Followers" :*/
fileprivate let str_styleText:String = "class heightFollowers"

/*: "Following" :*/
fileprivate let str_videoCollectName:[Character] = ["F","o","l","l","o","w","i","n","g"]

/*: "nav_back_black_nor" :*/
fileprivate let str_buttonValue:String = "nav_bacview video shared model"
fileprivate let str_tableValue:String = "k_blatype height"
...
class RequestViewController: MusicViewController {
    //: var currentIndex = 0
    var currentIndex = 0
...
//        segmentedDataSource.itemSpacing = 0
        ...
        segmentedDataSource.titleNormalColor = UIColor(hex: (String(str_backTitle) + str_pushData.capitalized))!
        //: segmentedDataSource.titleSelectedColor = UIColor.init(hex: "#333333")!
        segmentedDataSource.titleSelectedColor = UIColor(hex: (String(str_commitTitle)))!
        ...
        indicator.indicatorColor = UIColor(hex: (String(str_commitTitle)))!
    ...
    private lazy var titleArray: [String] = //: return ["Followers".localized, "Following".localized]
        [(String(str_styleText.suffix(9))).localized, (String(str_videoCollectName)).localized]
    //: }()

    //: private lazy var dataVC: [TalkingBaseViewController] = {
    private lazy var dataVC: [MusicViewController] = //: return [MeanViewController(), IndoorsObjectProtocol()]
        [MeanViewController(), IndoorsObjectProtocol()]
    //: }()
    ...
    private lazy var backButton: UIButton = {
        ...
        let img = UIImage.withView(name: (String(str_buttonValue.prefix(7)) + String(str_tableValue.prefix(5)) + "ck_nor")).withRenderingMode(.alwaysTemplate)
        //: btn.setImage(img, for: .normal)
        btn.setImage(img, for: .normal)
        //: btn.tintColor = .black
        btn.tintColor = .black
        //: btn.addTarget(self, action: #selector(backButtonClick), for: .touchUpInside)
        btn.addTarget(self, action: #selector(appIn), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension RequestViewController: JXSegmentedViewDelegate {
...
extension RequestViewController: JXPagingViewDelegate {
