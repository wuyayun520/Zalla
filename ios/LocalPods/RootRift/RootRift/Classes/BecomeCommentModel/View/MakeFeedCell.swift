...
fileprivate let str_indexValue:[UInt8] = [0xa5,0xaa,0xa5,0xb0,0x64,0x9f,0xab,0xa0,0xa1,0xae,0x76,0x65,0x5c,0xa4,0x9d,0xaf,0x5c,0xaa,0xab,0xb0,0x5c,0x9e,0xa1,0xa1,0xaa,0x5c,0xa5,0xa9,0xac,0xa8,0xa1,0xa9,0xa1,0xaa,0xb0,0xa1,0xa0]

fileprivate func cellTouch(row num: UInt8) -> UInt8 {
...
/*: "icon_chat_start" :*/
fileprivate let str_socialData:String = "return path background currenticon_"
fileprivate let str_equalData:String = "view var party_start"

/*: "#752FE9" :*/
fileprivate let str_modelData:String = "#752FEitem restriction var content"
fileprivate let str_colorValue:[Character] = ["9"]

/*: "#F5F5F5" :*/
fileprivate let str_phoneLabData:String = "#F5F5F5democrat to to view"

/*: "@ :*/
fileprivate let str_iconName:[Character] = ["@"]

/*: "btn_feed_dianzan_nor" :*/
fileprivate let str_genderData:[UInt8] = [0xe,0x18,0x2,0x33,0xa,0x9,0x9,0x8,0x33,0x8,0x5,0xd,0x2,0x16,0xd,0x2,0x33,0x2,0x3,0x1e]

private func firstCellSucceed(conversation num: UInt8) -> UInt8 {
    return num ^ 108
}

/*: "btn_feed_reply_nor" :*/
fileprivate let str_labelViewName:String = "btn_m destroy"
fileprivate let str_themeName:String = "reneverl"
...
class MakeFeedCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_indexValue.map{cellTouch(row: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var playView: UIImageView = {
        ...
        img.image = UIImage.withView(name: (String(str_socialData.suffix(5)) + "chat" + String(str_equalData.suffix(6))))
        //: img.isHidden = true
        img.isHidden = true
        //: return img
        return img
    ...
    private lazy var atNickNameLab: UILabel = {
        ...
        lab.textColor = UIColor(hex: (String(str_modelData.prefix(6)) + String(str_colorValue)))
    ...
    private lazy var mainContentView: UIView = {
        ...
        view.backgroundColor = UIColor(hex: (String(str_phoneLabData.prefix(7))))
...
extension MakeFeedCell {
    /// 刷新cell
    //: func refreshCell(_ model: TalkingRemindListModel) {
    func nudge(_ model: StreamModelTransformable) {
        //: headImgView.setUrlImage(urlStr: model.headPic, placeImg: UIImage.placeSquareBigImgBanner())
        headImgView.optionsFinish(urlStr: model.headPic, placeImg: UIImage.themeMapBanner())
        ...
        previewImgView.ofData(urlStr: model.imageUrl)
        ...
        let typeImgStr = (model.type == 0) ? String(bytes: str_genderData.map{firstCellSucceed(conversation: $0)}, encoding: .utf8)! : (String(str_labelViewName.prefix(4)) + "feed_" + str_themeName.replacingOccurrences(of: "never", with: "p") + "y_nor")
        //: statusIcon.image = UIImage.withView(name: typeImgStr)
        statusIcon.image = UIImage.withView(name: typeImgStr)
...
extension MakeFeedCell {
    ...
    private func visualProperty() {
        ...
        nickNameLab.snp.makeConstraints { make in
            ...
            make.width.lessThanOrEqualTo((kLet_scaleName - 128) / 2)
        }
