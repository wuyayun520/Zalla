...
/*: "AddCellThen" :*/
fileprivate let str_centerValue:String = "view medium bottomTalki"
fileprivate let str_routeValue:String = "name var framentPhoto"
fileprivate let str_nameValue:String = "sCellat model user color"
...
class GiftDoingDataSource: UICollectionView {
    ...
    func modelPush(model: CellMomentModel) {
        //: cunrrenModel = model
        cunrrenModel = model
        //: self.reloadData()
        self.reloadData()
...
extension GiftDoingDataSource: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_: UICollectionView, layout _: UICollectionViewLayout, insetForSectionAt _: Int) -> UIEdgeInsets {
        ...
        if cunrrenModel.pic.count == 4 {
            ...
            return UIEdgeInsets(top: 0, left: 0, bottom: 0, right: kLet_scaleName - 200 - 30)
    ...
    func collectionView(_: UICollectionView, layout _: UICollectionViewLayout, sizeForItemAt _: IndexPath) -> CGSize {
        ...
        if cunrrenModel.pic.count == 1 {
            ...
            var width = isMyhost ? (kLet_scaleName - 30 - 24 - 30) / 3 : (kLet_scaleName - 30 - 24) / 3
    ...
    func collectionView(_: UICollectionView, layout _: UICollectionViewLayout, referenceSizeForHeaderInSection _: Int) -> CGSize {
        ...
        return CGSize(width: kLet_scaleName, height: 1)
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell: AddCellThen = collectionView.dequeueReusableCell(withReuseIdentifier: (String(str_centerValue.suffix(5)) + "ngMome" + String(str_routeValue.suffix(7)) + String(str_nameValue.prefix(5))), for: indexPath) as! AddCellThen
        ...
        cell.withUrl(url: model.thumbUrl ?? "")
    ...
    func collectionView(_: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let vc = EleventhHourPhotosVc(momentModel: cunrrenModel, index: indexPath.row, type: .normal)
...
extension GiftDoingDataSource {
    ...
    private func addGame() {
        ...
        register(AddCellThen.self, forCellWithReuseIdentifier: (String(str_centerValue.suffix(5)) + "ngMome" + String(str_routeValue.suffix(7)) + String(str_nameValue.prefix(5))))
        //: dataSource = self
        dataSource = self
        //: delegate = self
        delegate = self
