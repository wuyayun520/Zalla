...
Pod::Spec.new do |s|
  ...
  s.requires_arc = true
  #s.public_header_files = 'RootRift/Classes/**/{RootRift,NSString+AES128,BaseJsonModel,RBDMuteSwitch,AbTalkingAuditGiftBroadcastView}.h', 'RootRift/Classes/BaseFile/**/*.h', 'RootRift/Classes/MessageModule/IMSDKModule/IMChat/**/*.h'
  s.source_files = 'RootRift/Classes/**/*'
  s.resources = "RootRift/Resources/*.bundle"
  s.vendored_libraries = 'RootRift/Classes/**/*.a'
